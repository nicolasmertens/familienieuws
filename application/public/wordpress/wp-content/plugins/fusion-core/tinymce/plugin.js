	...
	tinymce.create("tinymce.plugins.fusionShortcodes",
	{
		init: function ( ed, url )
		{
			ed.addCommand("fusionPopup", function ( a, params )
			{
				...
				// load thickbox
				tb_show("Fusion Shortcodes", url + "/popup.php?popup=" + popup + "&width=" + 800);
			});
		},
                ...
                if(FusionShortcodes.dev == 'true') {
	                ...
	                btn.onRenderMenu.add(function (c, b)
					{
                        ...
                        a.addImmediate({
                            ...
                            icon: 'fusion_blog',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[blog number_posts="10" cat_slug="" title="yes" thumbnail="yes" excerpt="yes" excerpt_words="35" meta_all="yes" meta_author="yes" meta_categories="yes" meta_comments="yes" meta_date="yes" meta_link="yes" paging="yes" scrolling="pagination" strip_html="yes" layout="large"][/blog]');
                            }
                        });
                        ...
                        a.addImmediate({
                            ...
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[counters_box][counter_box value="75"]Counter Title Goes Here[/counter_box][counter_box value="55"]Counter Title Goes Here[/counter_box][counter_box value="65"]Counter Title Goes Here[/counter_box][counter_box value="85"]Counter Title Goes Here[/counter_box][/counters_box]');
                            }
                        });
                        ...
                        a.addImmediate({
                            ...
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[progress percentage="60" filledcolor="" unfilledcolor=""]Web Design[/progress]');
                            }
                        });
                        ...
                        a.addImmediate({
                            ...
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[social_links colorscheme="" linktarget="" rss="" facebook="" twitter="" dribbble="" google="" linkedin="" blogger="" tumblr="" reddit="" yahoo="" deviantart="" vimeo="" youtube="" pinterest="" digg="" flickr="" forrst="" myspace="" skype=""]');
                            }
                        });
...
<td><strong>$10.00</strong></td> \
                        ...
                        a.addImmediate({
                            ...
                            icon: 'fusion_vimeo',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[vimeo id="Enter video ID (eg. 10145153)" width="600" height="350"]');
                            }
                        });
                        ...
                        a.addImmediate({
                            ...
                            icon: 'fusion_youtube',
                            onclick : function() {
                                tinyMCE.activeEditor.execCommand( "mceInsertContent", false, '[youtube id="Enter video ID (eg. Wq4Y7ztznKc)" width="600" height="350"]');
                            }
                        });
