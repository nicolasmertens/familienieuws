...
add_shortcode('button', 'shortcode_button');
	function shortcode_button($atts, $content = null) {
		...
		if($animation_type) {
			...
			return '<a class="button ' . $atts['size'] . ' ' . $atts['color'] .$animation_class .'" href="' . $atts['link'] . '" target="' . $atts['target'] . '"'.$animation_attribues.'>' .do_shortcode($content). '</a>';
	}
...
$subject = file_get_contents(get_template_directory().'/fonts/fontawesome.css');
...
add_shortcode('checklist', 'shortcode_checklist');
	...
	.post-content #checklist-{$avada_checklist_box_counter} li:before{color:{$iconcolor} !important; {$css_attributes} }
	.rtl .post-content #checklist-{$avada_checklist_box_counter} li:after{color:{$iconcolor} !important; {$css_attributes} }
	</style>";
...
add_shortcode('content_boxes', 'shortcode_content_boxes');
	function shortcode_content_boxes($atts, $content = null) {
		...
		preg_match_all('/(\[content_box (.*?)\](.*?)\[\/content_box\])/', $content, $matches);
	...
	if($atts['name'] || $atts['title'] || $atts['facebooklink'] || $atts['twitterlink'] || $atts['linkedinlink'] || $content) {
		...
		if($data['social_links_color'] == 'Dark') {
			...
			$html .= '<div class="person-author '.$icons_color_scheme.' clearfix">';
				...
				if($atts['rss']) {
					$html .= '<span class="social-icon"><a href="' . $atts['rss'] . '" target="'.$atts['linktarget'].'" class="rss">RSS</a><div class="popup">
						<div class="holder">
							<p>RSS</p>
						</div>
					</div></span>';
				...
				if($atts['youtube']) {
					$html .= '<span class="social-icon"><a href="' . $atts['youtube'] . '" target="'.$atts['linktarget'].'" class="youtube">YouTube</a><div class="popup">
						<div class="holder">
							<p>YouTube</p>
						</div>
					</div></span>';
				...
				if($atts['pinterest']) {
					$html .= '<span class="social-icon"><a href="' . $atts['pinterest'] . '" target="'.$atts['linktarget'].'" class="pinterest">Pinterest</a><div class="popup">
						<div class="holder">
							<p>Pinterest</p>
						</div>
					</div></span>';
				...
				if($atts['flickr']) {
					$html .= '<span class="social-icon"><a href="' . $atts['flickr'] . '" target="'.$atts['linktarget'].'" class="flickr">Flickr</a><div class="popup">
						<div class="holder">
							<p>Flickr</p>
						</div>
					</div></span>';
				...
				if($atts['vimeo']) {
					$html .= '<span class="social-icon"><a href="' . $atts['vimeo'] . '" target="'.$atts['linktarget'].'" class="vimeo">Vimeo</a><div class="popup">
						<div class="holder">
							<p>Vimeo</p>
						</div>
					</div></span>';
				...
				if($atts['tumblr']) {
					$html .= '<span class="social-icon"><a href="' . $atts['tumblr'] . '" target="'.$atts['linktarget'].'" class="tumblr">Tumblr</a><div class="popup">
						<div class="holder">
							<p>Tumblr</p>
						</div>
					</div></span>';
				...
				if($atts['google']) {
					$html .= '<span class="social-icon"><a href="' . $atts['google'] . '" target="'.$atts['linktarget'].'" class="google">Google+</a><div class="popup">
						<div class="holder">
							<p>Google+</p>
						</div>
					</div></span>';
				...
				if($atts['digg']) {
					$html .= '<span class="social-icon"><a href="' . $atts['digg'] . '" target="'.$atts['linktarget'].'" class="digg">Digg</a><div class="popup">
						<div class="holder">
							<p>Digg</p>
						</div>
					</div></span>';
				...
				if($atts['blogger']) {
					$html .= '<span class="social-icon"><a href="' . $atts['blogger'] . '" target="'.$atts['linktarget'].'" class="blogger">Blogger</a><div class="popup">
						<div class="holder">
							<p>Blogger</p>
						</div>
					</div></span>';
				...
				if($atts['skype']) {
					$html .= '<span class="social-icon"><a href="' . $atts['skype'] . '" target="'.$atts['linktarget'].'" class="skype">Skype</a><div class="popup">
						<div class="holder">
							<p>Skype</p>
						</div>
					</div></span>';
				...
				if($atts['myspace']) {
					$html .= '<span class="social-icon"><a href="' . $atts['myspace'] . '" target="'.$atts['linktarget'].'" class="myspace">Myspace</a><div class="popup">
						<div class="holder">
							<p>Myspace</p>
						</div>
					</div></span>';
				...
				if($atts['deviantart']) {
					$html .= '<span class="social-icon"><a href="' . $atts['deviantart'] . '" target="'.$atts['linktarget'].'" class="deviantart">Deviantart</a><div class="popup">
						<div class="holder">
							<p>Deviantart</p>
						</div>
					</div></span>';
				...
				if($atts['yahoo']) {
					$html .= '<span class="social-icon"><a href="' . $atts['yahoo'] . '" target="'.$atts['linktarget'].'" class="yahoo">Yahoo</a><div class="popup">
						<div class="holder">
							<p>Yahoo</p>
						</div>
					</div></span>';
				...
				if($atts['reddit']) {
					$html .= '<span class="social-icon"><a href="' . $atts['reddit'] . '" target="'.$atts['linktarget'].'" class="reddit">Reddit</a><div class="popup">
						<div class="holder">
							<p>Reddit</p>
						</div>
					</div></span>';
				...
				if($atts['forrst']) {
					$html .= '<span class="social-icon"><a href="' . $atts['forrst'] . '" target="'.$atts['linktarget'].'" class="forrst">Forrst</a><div class="popup">
						<div class="holder">
							<p>Forrst</p>
						</div>
					</div></span>';
	...
	wp_reset_query();
		...
		while($gallery->have_posts()): $gallery->the_post();
			if(has_post_thumbnail() || get_post_meta(get_the_ID(), 'pyre_video', true)):
				...
				$html .= '<div class="portfolio-item '.$item_classes.'">';
					if(has_post_thumbnail()):
					$html .= '<div class="image'.$animation_class.'"'.$animation_attribues.'>';
						if($data['image_rollover']):
						$thumbnail = wp_get_attachment_image_src(get_post_thumbnail_id(get_the_ID()), $portfolio_image_size);
						$html .= '<img src="'.$thumbnail[0].'" alt="'.get_post_field('post_excerpt', get_post_thumbnail_id(get_the_ID())).'" />';
						else:
...
function shortcode_client($atts, $content = null) {
	...
	$html = '<li>';
	$html .= '<a href="'.$atts['link'].'" target="'.$linktarget.'"><img src="'.$atts['image'].'" alt="'.$atts['alt'].'" /></a>';
	$html .= '</li>';
	return $html;
}
	...
	while( $ml_query->have_posts() ) :
		...
		if($atts['layout'] == 'timeline') {
			if($prev_post_month != $post_month) {
				$html.= '<div class="timeline-date"><h3 class="timeline-title">' . get_the_date("F Y") .'</h3></div>';
			}
		}
