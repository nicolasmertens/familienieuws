	...
	jQuery(window).scroll(function() {
		 ...
		 if(header > headerHeight) {			
			if( jQuery('.sticky').length < 1) {
				...
				if (jQuery(logo).height() > 45) {
					logo_height = "45px";
					logo_line_height = "45px";
					logo_padding_top = "5px";
				} else {
					logo_height = jQuery(logo).height()+"px";
					logo_line_height = jQuery(logo).height()+"px";
					logo_padding_top = (55 - jQuery(logo).height()) / 2;
				}
				jQuery(logo).animate({
				height: logo_height,
				'line-height': logo_line_height,
			...
			jQuery('.sticky-header').css( "height", "" );
			jQuery('.sticky-header').css( "opacity", "" );
			if( jQuery('.retina_logo').length >= 1) {
				jQuery(logo).css( "height", orig_logo_height );
			} else {
				jQuery(logo).css( "height", "" );
