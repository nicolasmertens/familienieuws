...
// Set the Options Array
        ...
        $of_options[] = array( "name" => "Custom Nav / Headings Font",
            ...
            "std" => "<h3 style='margin: 0;''>Custom Font Is Only for navigation menus and headings.</h3><p style='margin-bottom:0;'>This will overwrite the google / standard font options if custom font files are uploaded.</p>",
            "icon" => true,
            "type" => "info");
        ...
        $of_options[] = array( "name" => "Sliding Bar Widget Title Font Size (px)",
            "desc" => "Default is 13",
        ...
        $of_options[] = array( "name" =>  "Menu Background Color For Header 4 & 5",
        ...
        $of_options[] = array( "name" =>  "Menu Background Hover Color - Sublevels",
...
// Theme Specific Options
        ...
        $of_options[] = array( "name" => "Plugins",
            "desc" => "",
            "id" => "plugins_only",
            "std" => "<h3 style='margin: 0;'>Enable / Disable Support For Plugins Installed Manually</h3>",
            "icon" => true,
            "type" => "info");
        ...
        $of_options[] = array( "name" => "Plugins",
            "desc" => "",
            "id" => "plugins_only",
            "std" => "<h3 style='margin: 0;'>Enable / Disable Plugins Integrated Within The Theme</h3>",
            "icon" => true,
            "type" => "info");
        ...
        $of_options[] = array( "name" => "JS",
            "desc" => "",
            "id" => "js_only",
            "std" => "<h3 style='margin: 0;'>Enable / Disable Support For Javascript Within The Theme </h3>",
            "icon" => true,
            "type" => "info");
        ...
        $of_options[] = array( "name" => "Show Woocommerce My Account Link in Top Navigation",
        ...
        $of_options[] = array( "name" => "Show Woocommerce My Account Link in Main Navigation",
        ...
        $of_options[] = array( "name" => "Show Woocommerce Cart Link in Main Navigation",
