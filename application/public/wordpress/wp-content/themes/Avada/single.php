<?php get_header(); ?>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('post'); ?>>
			...
			<div class="share-box">
				...
				<ul class="social-networks social-networks-<?php echo strtolower($data['socialbox_icons_color']); ?>">
					...
					<li class="reddit">
						<a href="http://reddit.com/submit?url=<?php the_permalink(); ?>&amp;title=<?php the_title(); ?>" target="_blank">
							Reddit
						</a>
						<div class="popup">
							<div class="holder">
  ...
  '', 'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=600,width=600');return false;" target="_blank">
					...
					<li class="pinterest">
						<?php $full_image = wp_get_attachment_image_src(get_post_thumbnail_id(), 'full'); ?>
						<a href="http://pinterest.com/pin/create/button/?url=<?php echo urlencode(get_permalink()); ?>&amp;description=<?php echo urlencode($post->post_title); ?>&amp;media=<?php echo urlencode($full_image[0]); ?>" target="_blank">
							Pinterest
						</a>
						<div class="popup">
							<div class="holder">
