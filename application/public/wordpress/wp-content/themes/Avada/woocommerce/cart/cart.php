...
<div class="cart-collaterals clearfix">
	...
	<div class="woocommerce-content-box one_half last cart-totals-container">
		...
		<input type="submit" class="comment-submit small button" name="update_cart" value="<?php _e( 'Update Shopping Cart', 'woocommerce' ); ?>" /> <input type="submit" class="comment-submit small checkout-button button alt" name="proceed" value="<?php _e( 'Proceed to Checkout &rarr;', 'woocommerce' ); ?>" />
	</div>
