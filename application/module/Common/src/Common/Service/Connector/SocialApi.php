<?php
namespace Common\Service\Connector;
...
class SocialApi {
    ...
    public function Initialize()
    {
        ...
        switch ($this->provider) {
            ...
            case 'Instagram':
                ...
                $this->dialogUrl = 'https://api.instagram.com/oauth/authorize/?';
                $this->accessTokenUrl = 'https://api.instagram.com/oauth/access_token?';
                $this->responseType = "code";
                $this->state = "";
                $this->userProfileUrl = "https://https://api.instagram.com/v1/users/self?";
                $this->header = "";
                break;
    ...
    public function getAccessToken()
    {
        $postvals = "client_id=" . $this->client_id
                ...
                . "&redirect_uri=" . urlencode($this->redirect_uri)
                . "&code=" . $this->code;
        $this->accessToken = $this->curl_request($this->accessTokenUrl, 'POST', $postvals);
